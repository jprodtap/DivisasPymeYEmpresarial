...
public class ControllerValiPymeMiddle1 {

	String tipoIdEm, clieEmpresa, servicio, idEmpresa, numIdUser, tipoIDUser, combo, nombreEmpre,numfirmas;

	PageLoginPymes1 pageLogPymes = null;
	PageAdministracion1 pageAdministracion = null;
	PageServicios1 pageServicios = null;
	PageUsuariosEmpresa1 pageUsuaEmp = null;
...
//=======================================================================================================================
	public ControllerValiPymeMiddle1(PageLoginPymes1 pageParent) {
		pageAdministracion = new PageAdministracion1(pageParent);
		pageServicios = new PageServicios1(pageParent);
		pageUsuaEmp = new PageUsuariosEmpresa1(pageParent);
		pageOrigen = new PageOrigen1(pageParent);

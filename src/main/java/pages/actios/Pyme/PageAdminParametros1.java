...
public class PageAdminParametros1 extends PagePortalPymes1 {
...
//=======================================================================================================================
	 ...
	 */
	public PageAdminParametros1(PageLoginPymes1 parentPage) {
		super(parentPage);
	}
...
//***********************************************************************************************************************
	...
	public String hacerConfiguracion(String numAprobaciones, String tipoAbono, String ctaInscrita) throws Exception {
		...
		if (this.isDisplayed(bienvenido)) {
			WebElement getexto = this.element(bienvenido);

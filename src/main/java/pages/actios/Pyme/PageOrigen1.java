...
public class PageOrigen1 extends PagePortalPymes1 {
...
//=======================================================================================================================	
	public PageOrigen1(BasePageWeb parentPage) {
		super(parentPage);
	}
...
//***********************************************************************************************************************	
	...
	public void TxInternacionalesOrigen() throws Exception {
		...
		WebElement iframe = this.element(By.id("cphCuerpo_IframeDivisas"));
		...
		if (descripcion.equals("Descuento por Pago a Proveedores")
			...
			do {
				...
				if (this.element(By.xpath(registroAdenda)) != null && !encontrado) {
					...
					WebElement WebDataAdenda = this.element(By.xpath(locDataAdenda));
		...
		if (encontrado && !servicio.equals("Pago a Proveedores") && !servicio.equals("Nómina")) {
			...
			do {
				...
				if (this.element(xPathLinkNomProveedores) != null) {
					...
					WebElement locDataNomProveedores = this.element(By.xpath(xPathDataNomProveedores));
...
// ***********************************************************************************************************************
	...
	public void TransferenciaPortalDetalleReferencia(String detalleVacio) throws Exception {
		...
		if (detalleVacio.equals("Pago de Nóminas") || detalleVacio.equals("Pago a Proveedores")) {
			...
			WebElement referenciaElement = this.element(By.xpath("//*[@id=\"cphCuerpo_lblEjecutadoReferencia\"]"));
			referencia = referenciaElement.getText();

			WebElement detalleElement = this.element(By.xpath("//*[@id=\"cphCuerpo_lblEjecutadoDescripcion\"]"));
			detalle = detalleElement.getText();

		} else {

			WebElement referenciaElement = this.element(By.xpath("//*[@id=\"cphCuerpo_lblERReferencia\"]"));
			referencia = referenciaElement.getText();

			WebElement detalleElement = this.element(By.xpath("//*[@id=\"cphCuerpo_lblERDescripcion\"]"));
			detalle = detalleElement.getText();
...
// ***********************************************************************************************************************
	...
	public void NotaDebitoDetalleReferencia(String detalleVacio) throws Exception {
		...
		try {
			...
			WebElement detalleElement = this.element(By.xpath("//*[@id=\"cphCuerpo_lblCDDetalle\"]"));
			detalle = detalleElement.getText();

			WebElement referenciaElement = this.element(By.xpath("//*[@id=\"cphCuerpo_lblCDReferencia\"]"));
			referencia = referenciaElement.getText();

...
// ============================================[ModuloDocumetosYFormularios]===========================================================================
	...
	public String ModuloDocumetosYFormularios(String tipoPrueba, String servicio, String fechaTx, String horaTx,
		...
		if (isValid(msg) && !msg.contains("En este módulo puede visualizar las operaciones")
...
//				String conceptoAcambiar = SettingsRun.getTestData().getParameter("Concepto de la transferencia A Cambiar");
		...
		if (conceptosCambiario.contains(Inversiones) && isValid(tipoDestinodelainversion)) {
			...
			do {
				...
				if (contador > 30) {
					...
					if (this.element(sesionEx) != null) {
						...
						Evidence.save("No se presento el campo Destino de la inversión",this);
			...
			if (isValid(conceptosCambiario)) {
				...
				Evidence.save("Campo-Seleccione Destino de la inversión",this);
...
//					Util.wait(5);
			...
			do {
				...
				if (contador >= 30) {
					...
					if (this.element(sesionEx) != null) {
						...
						Evidence.save("No se presento el campo Opción de inversión",this);
			...
			if (isValid(conceptosCambiario)) {
				...
				Evidence.save("Campo-Seleccione Opción de inversión",this);
...
//			this.write(this.element(listDeclaracióndeimportaciónNo), String.valueOf(Util.enteroRandom(1, 100)));

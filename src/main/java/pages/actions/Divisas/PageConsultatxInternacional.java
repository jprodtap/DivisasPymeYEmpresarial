...
// ============================================[InicioConsulta]===========================================================================
	...
	public String InicioConsulta(String servicio, String tipoConstaTxRealizadas, String ordenanteBeneficiario,
		...
		if (tipoConstaTxRealizadas.equals("Día actual")) {
			...
			Evidence.save("Filtros ingresados",this);
...
// ============================================[SelectCalendarDate]===========================================================================
	...
	public void SelectCalendarDate(String fecha, By abrirCalendario, By mes, String elementoDiaXpath, By año) {
		...
		// Abre el calendario
		WebElement calendarButton = this.element(abrirCalendario);
		...
		// Selecciona el mes
		Select monthSelect = new Select(this.element(mes));
		monthSelect.selectByVisibleText(monthText);

		// Selecciona el año
		Select yearSelect = new Select(this.element(año));
